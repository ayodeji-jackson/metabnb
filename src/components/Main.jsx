      ...
      <section className='flex gap-5 flex-col px-5 sm:px-16 md:flex-row lg:px-24 flex-1'>
        <div className='space-y-3 flex-1 md:pt-[5vw]'>
          ...
          <div className='flex flex-col gap-1 sm:flex-row sm:gap-0'>
            <input type="search" placeholder="Search for location" className='py-2 px-4 text-sm border border-gray-400 rounded-md sm:rounded-r-none' />
            <button className='text-white bg-primary rounded-md py-2 px-5 sm:rounded-l-none'>Search</button>
          </div>
        </div>
